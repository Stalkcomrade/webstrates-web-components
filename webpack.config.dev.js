...
const { VueLoaderPlugin } = require(path.resolve(definedPath, 'vue-loader'));
                ...
                options: {
                  plugins: [
                    ...
                    presets: [
                      ...
                      [require.resolve(path.resolve(definedPath, "@babel/preset-env"), { 'modules': false, 'targets': { 'node': 4 }})]
                    ]
                }
              }
            },
